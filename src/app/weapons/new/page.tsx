...
export default function WeaponNewPage() {
  ...
  return (
    <AdminLayout title="武器新規作成">
      <div className="p-6">
        <div className="mb-6">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-2xl font-bold text-gray-900">武器新規作成</h1>
            <Link
              href="/weapons"
