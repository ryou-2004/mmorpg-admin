...
export default function ArmorEditPage({ params }: { params: { id: string } }) {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      await apiClient.patch(`/admin/armors/${params.id}`, { armor: armorData })
      router.push(`/armors/${params.id}`)
    } catch (error: any) {
      if (error.response?.data?.errors) {
        setErrors(error.response.data.errors)
      } else {
        setErrors(['防具の更新に失敗しました'])
      }
    } finally {
      setSaving(false)
    }
      ...
      <div className="p-6">
        <div className="mb-6">
          <div className="flex justify-between items-center mb-4">
            <h1 className="text-2xl font-bold text-gray-900">防具編集: {armor.name}</h1>
            <Link
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              ...
              <div>
                ...
                <select
                  name="armor_category"
                  id="armor_category"
                  defaultValue={armor.armor_category}
                  required
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                >
              ...
              <div>
                ...
                <input
                  ...
                  defaultValue={armor.level_requirement}
                  min="1"
                  max="100"
                  className="mt-1 block w-full border-gray-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
                />
            ...
            <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
              <div>
                ...
                <input
                  ...
                  id="job_requirement"
                  defaultValue={armor.job_requirement?.join(', ')}
